...
if __name__ == '__main__':
    ...
    print("wwe4:")
    print(Path(__file__))
    print(" prima script_name")
    print(script_name)
    print("script_name dopo ")
    #os.system(f"manim code3.py -p")
    print("good")
    print(f"manim {script_name}")
    # Cmdan
    print(f"manim {script_name} {SCENE} {FLAGS}")
    os.system(f"manim {script_name} {SCENE} {FLAGS}")
    print(f"manim {script_name} {SCENE} {FLAGS} dopo")